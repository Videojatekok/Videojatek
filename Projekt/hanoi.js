korongok = document.getElementsByClassName('korong')
    ...
    function mozgat(honnan, hova) // tömbelemek mozgatása a memóriába
    {
    ...
    function hanoi(db, honnan, hova, seged) //rekurzív megvalósítás
    {
...
// Szemléletes: pakolas_sorrend[] tömb bmeutatása
    ...
    function pakolas_mutatas(i)  // A mozgatás megjelenítése képernyőn 
    {
        ...
        document.getElementById('idojelzo_csik').style.width = i/(pakolas_sorrend-1)*520 + 'px'
